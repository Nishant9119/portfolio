...
import { Menu, X, Home, GraduationCap, Briefcase, BookOpen, Code, Award, Heart, Users, FolderOpen, FileText } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <button
            ...
            className="text-xl font-bold text-foreground hover:text-primary transition-colors text-left whitespace-nowrap ml-6 md:-ml-36"
          >
            Nishant Sharma
          </button>
